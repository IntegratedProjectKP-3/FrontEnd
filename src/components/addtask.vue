...
const AddTask = () => {
  if (title.value.trim() === null || title.value.trim() === "") {
    ...
    fetch(`${import.meta.env.VITE_BASE_URL}/tasks`, requestOptions).then(
...
<template>
  <div class="itbkk-modal-task">
    <div class="px-4">
      <h1 class="p-2 border-b-black border-solid border-b-[1px]">New Task</h1>
      <h1 class="text-red-600" v-if="overlimitField">
        "some field is over limit"
      </h1>
      <div class="flex flex-row p-3">
        ...
        <div class="flex flex-col pl-3">
          ...
          <div class="pt-[200px] flex justify-center">
            <button class="bg-blue-500 px-3 py-2 rounded-lg" @click="checkJSON">
              Check json
            </button>
            <div class="px-2">
              <button
