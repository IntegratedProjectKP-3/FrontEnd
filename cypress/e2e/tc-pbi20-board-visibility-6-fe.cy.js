describe(`TC-PBI20-BOARD-VISIBILITY-1-FE\n 
    ...
    beforeEach(()=> {
        ...
        cy.wait(100)
        cy.visit('/board/dcc2fc8e7c')  // <------ add your board id here
    }) ;
    ...
    it(`[Step 2.4] Should no open /board/:id/task/add page and 
        ...
        cy.visit('/board/dcc2fc8e7c/task/add') // <------ add your board id here
    ...
    it(`[Step 2.5] Should no open /board/:id/task/:task-id/edit page and 
        ...
        cy.visit('/board/dcc2fc8e7c/task/84/edit') // <------ add your board id and task id here
    ...
    it(`[Step 2.6] Should no open /board/:id/status/add page and 
        ...
        cy.visit('/board/dcc2fc8e7c/status/add') // <------ add your board id here
    ...
    it(`[Step 2.7] Should no open /board/:id/status/:status-id/edit page and 
        ...
        cy.visit('/board/dcc2fc8e7c/status/192/edit') // <------ add your board id and status id here
